...
void MainWindow::on_pushButton_Play_Pause_clicked()
{
    ...
    if (!pipeline)
    { // Если пайплайн не запущен, запускаем его
    ...
    { // Если пайплайн уже работает, останавливаем его
...
void MainWindow::useKeyBoard(bool checked)
{
    if (keyBoard != nullptr)
    {
        delete keyBoard;
...
void MainWindow::setConnection()
{
    ...
    communicationAgent1 = new Pult::PC_Protocol(QHostAddress("192.168.1.111"), 13053,
                                                QHostAddress("192.168.1.11"), 13052, 10, 0);
    communicationAgent2 = new Pult::PC_Protocol(QHostAddress("192.168.13.102"), 13057,
                                                QHostAddress("192.168.13.3"), 13058, 10, 1);
...
void MainWindow::setTab()
{
    ...
    ui->tabWidget->setTabText(4, "Видео"); // виджет с видео
}
