...
void IControlData::setRotman(quint8 rotman) {
    agent[getCurrentAgent()].control.rotman = rotman;
}

void IControlData::setOffPower(quint8 offPower) {
    agent[getCurrentAgent()].control.offPower = offPower;
}
